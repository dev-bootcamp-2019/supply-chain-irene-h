...
contract SupplyChain {
    ...
    */
    ...
    modifier checkValue(uint _sku) {
        ...
        items[_sku].seller.transfer(amountToRefund);
    }
    ...
    modifier forSale (uint _sku) {
        require(items[_sku].state == State.ForSale,"Item not available for sale");
        _;
    }
    ...
    modifier shipped (uint _sku) {
        require(items[_sku].state == State.Shipped,"Item not yet shipped");
        _;
    }
    modifier received (uint _sku) {
        require(items[_sku].state == State.Received,"Item not yet received");
        _;
    }
